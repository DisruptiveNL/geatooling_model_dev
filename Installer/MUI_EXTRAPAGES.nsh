...
!verbose push
!verbose 3
    LangString ${UN}ReadmeHeader     "${ReadmeHeader}"
    LangString ${UN}ReadmeSubHeader  "${ReadmeSubHeader}"
    LangString ${UN}ReadmeTextTop    "${ReadmeTextTop}"
    LangString ${UN}ReadmeTextBottom "${ReadmeTextBottom}"
!verbose pop
!macroend
