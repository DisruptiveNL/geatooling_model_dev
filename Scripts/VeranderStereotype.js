 ...
 * Purpose:     Maak van Uitspraak - Richtinggevende Uitspraak
 *
 * Created:     Maart 2021
 * Updated:     Maart 2021
 * 
...
function Veranderstereotype(typeStereotypeFrm, typeStereotypeTo)
{
	...
	switch (treeSelectedType) {
		case otPackage :
		{
			...
			{
				//Session.Prompt("Elements [ " + thePackage.Elements.Count +
				//	               " ]\n", promptOK);
				...
				//for (var index = 0; index < 20; index++)
				{
					...
					//Session.Prompt("Elements [ " + elem.Name +
					//               " ]\n", promptOK);
					...
					if ( typeVormgeving == typeStereotypeFrm )
					{
						...
						Session.Output( " [ " + elem.Stereotype +
					               " ]\n");
...
//Veranderstereotype("Uitspraak", "RichtinggevendeUitspraak");